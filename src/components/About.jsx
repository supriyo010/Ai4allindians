...
const About = () => {
  return (
    <div className=" md:min-h-screen flex flex-col-reverse md:flex-row items-center gap-4 md:mx-41 mx-5 mt-14">
      ...
      <h1 className="bo px-16" ><b className="animate:front"><i>"WE PROVIDE FREE CERTIFIED COURSES, e-BOOKS & AI TOOLS FROM TOP EXPERTS AND OTHER INTERESRTING INTERNSHIP OPPUTUNITIES WITH GOVERNMENT OF INDIA CERTIFICATIONS AND BONUS GIFTS AS WELL. DEDICATED COMMUNITY FOR ALL DOUBTS AND UPDATES OF UPCOMING EVENTS. ALSO OFFERS A FREE PLATFORM FOR ALL TEACHERS WHO WANT TO DELIVER THEIR SUBJECTS ON OUR PLATFORM AND EARN. WE ARE NON PROFIT ORGANIZATION DONATES ALL OUR SERVICE CHARGES TO NEEDY AND GREEDY PEOPLE AT DIWALI EVERY YEAR"</i></b></h1>
      </div>
      </div>
